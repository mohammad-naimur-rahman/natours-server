...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmFpbXVyLXJhaG1hbiIsImEiOiJja3c0a3R3cDMwN2p4MnZudnE5MTIxd3UzIn0.I2P1ISCgCgcAtw-yOSitgw';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:8000/api/v1/users/".concat(urlType),
              data: data
            });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:8000/api/v1/bookings/checkout-sessions/".concat(tourId));
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Something went wrong, try again later!');
...
var userDataForm = document.querySelector('#update-account-form');
var userPasswordForm = document.querySelector('#update-password-form');
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              e.target.textContent = 'Processing...'; // 1) Get the data

              tourId = e.target.dataset.tourId; // 2) Make request to book tour
